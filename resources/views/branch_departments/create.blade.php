...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>New branch_department creating</h2>
            </div>
    ...
    <form action="{{ route('branch_departments.store') }}" method="POST">
        @csrf
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input id="branch_idInput" type="text" name="branch_id" class="form-control" placeholder="branch_id">
                </div>
            </div>
            <p></p>
            <div class="col-xs-12 col-sm-12 col-md-12">
