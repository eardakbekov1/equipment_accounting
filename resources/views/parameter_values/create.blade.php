...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>New parameter_value creating</h2>
            </div>
    ...
    <form action="{{ route('parameter_values.store') }}" method="POST">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input id="parameter_device_name_idInput" type="text" name="parameter_device_name_id" class="form-control" placeholder="parameter_device_name_id">
                </div>
            </div>
            <p></p>
            <div class="col-xs-12 col-sm-12 col-md-12">
